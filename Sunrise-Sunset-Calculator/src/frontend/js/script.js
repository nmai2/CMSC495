...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('reset-btn').addEventListener('click', function () {
        ...
        //Scroll the user to the location of the page anchor "reset anchor",
            //anchor should be located at the top of the user-input section.
        location.href = "#";
        location.href = "#reset-anchor";
    });
...
function scrollToResults() {
    // Scroll the page to the location of the page anchor "calculate-anchor",
        // anchor should be located at the top of the results section.
    location.href = "#";
    location.href = "#calculate-anchor";
}
